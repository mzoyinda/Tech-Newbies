...
| Role  |  Location |  Tags |
|---|---|-------------|
|[Graduate BE PHP Developer](https://www.ayko.com/careers/graduate-php-developer#apply-section) | remote |Every successful applicant is given a 6-month internal course, a graduation leading to a job offer as a junior within the company, an initial 3-5 year plan for becoming a Mid-level developer, and all the tools necessary to go beyond.|
|[Junior Node.js Developer](https://www.allegrow.co/jobs/junior-node-js-developer#job-requirements) | remote |Experience with Node.js and the most common packages in the ecosystem, such as Express|
|[Junior Angular developer](https://ncube.com/career/junior-angular-developer) | remote |Experience with HTML and CSS and Familiarity with RESTful APIs|
|[Data Engineer/Analyst](https://www.diversifytech.co/job-board/GuqI4mgGmjeRcn) | remote |Strong Python and SQL skills|
|[Entry/Intermediate Designer - Generalist](https://www.diversifytech.co/job-board/E3bfs7LYyCKhxz) | remote |Also great if you have: UX design skills, illustration skills, animation/motion graphics skills, and experience preparing files for print|
|[Front End Engineer (React)](https://apply.workable.com/revunit-1/j/126E7A47E6/) | remote | You have at least two years of experience working on a cross-functional team of designers & product managers and feel confident enough in your skills to deliver on enterprise projects quickly.|
|[Software Development Internships](https://internshala.com/int-earn-revolution2022/category-software%2520development%2Cweb%2520development) | remote | machine learning, software development, web development |
...
| Name  |  Description|
|---|-----------------------------------|
|[Women in Tech Summit 2002 Registration](https://productledhub.com/women-in-tech-summit/registration/?utm_source=newsletter&utm_medium=email&utm_campaign=WIT+Summit+-+Prodyna+Keynote+Announcement&cmid=3a662f93-90aa-43f7-8aea-ad1a1e689d7d) |Enjoy live sessions & workshops and learn the latest developments on career development. |
|[INNOVATION IN DESIGN 2022](https://www.ideatelabs.co/innovation-in-design-2022-conference) |DESIGN TRENDS, AND THEIR IMPACT ON THE FUTURE |
|[Interswitch career fair](https://www.linkedin.com/posts/interswitch-limited_talent-interswitchcareerfair-maketheswitch-activity-6921101013412122624-X7gg/?utm_source=linkedin_share&utm_medium=android_app) |Interswitch Group  presents an opportunity to engage with talent from various career backgrounds who are essentially motivated to break into the tech/fintech ecosystem|
|[UX/UI DESIGNATHON 2022](https://www.avocademy.com/designathon?referral=4alwpzv&refSource=copy) |At Avocademy we believe that great UX/UI Design can change the world, so we are challenging you to solve a problem in a week |
